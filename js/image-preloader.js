const preload = src => new Promise(function(resolve, reject) {
  ...
  const sources = [
    ...
    'img/demo-carousel/g-1-0.jpg',
    'img/demo-carousel/g-1-1.jpg',
    'img/demo-carousel/g-1-2.jpg',
    'img/demo-carousel/g-2-0.jpg',
    'img/demo-carousel/g-2-1.jpg',
    'img/demo-carousel/g-2-2.jpg',
    ...
    'img/itemsNurture/addOneVerdancy-icon.png',
    'img/itemsNurture/fertilizer-icon.png',
    'img/itemsNurture/trowel-icon.png',
    'img/itemsNurture/watering-can-icon.png',
